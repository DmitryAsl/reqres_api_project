...
def test_post_create_user():
    ...
    response = api_request(method='POST', url=url, json=body)
    response_json = response.json()
...
def test_put_update_user():
    ...
    response = api_request(method='PUT', url=url, json=body)
    response_json = response.json()
...
def test_register_new_user():
    ...
    try:
        ...
        if user_id:
            ...
            response = api_request(method='DELETE', url=f'{BASE_URL}/api/users/{user_id}')
